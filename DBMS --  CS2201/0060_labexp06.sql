...
-- 'root@localhost', 'RVU-PC-057', '8.4.6', '2025-09-29 11:28:04'
...
-- Write the SQL Statement for the above Question
select job_id,avg((min_salary+max_salary)/2) from jobs
group by job_id;
...
'10000.00', '10000.00', '10000.000000'
...
-- Write the SQL Statement for the above Question
select job_id,job_title,avg((min_salary+max_salary)/2) from jobs
group by job_id
having avg((min_salary+max_salary)/2)>8000;
